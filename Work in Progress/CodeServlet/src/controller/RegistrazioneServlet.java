...
public class RegistrazioneServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int num = Integer.parseInt(numero);
				//creo il bean Utente e verifico se � gi� presente in DB
		...
		if(utenteDAO.retriveByUsername(username) == null &&
			...
			//Poich� non � presente, lo aggiungo in DB e alla sessione
			...
			throw new MyServletException("Username o email gi� presenti.");
