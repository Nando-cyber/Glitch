...
import com.glitch.demo.model.bean.Richiesta;
import com.glitch.demo.model.bean.Utente;
import com.glitch.demo.model.bean.ValidazioneRichiesta;
import com.glitch.demo.model.dao.RichiestaDAO;
import com.glitch.demo.model.dao.RichiestaDB;
...
public class RispostaAssistenzaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		rc.setStato(true);// il suo stato ora � true perch� � stata letta
